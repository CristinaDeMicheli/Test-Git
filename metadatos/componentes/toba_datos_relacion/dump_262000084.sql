------------------------------------------------------------
--[262000084]--  Gestion Persona - datos 
------------------------------------------------------------
...
INSERT INTO apex_objeto_dependencias (proyecto, dep_id, objeto_consumidor, objeto_proveedor, identificador, parametros_a, parametros_b, parametros_c, inicializar, orden) VALUES (
	'leanInicial', --proyecto
	'262000066', --dep_id
	'262000084', --objeto_consumidor
	'262000052', --objeto_proveedor
...
INSERT INTO apex_objeto_datos_rel_asoc (proyecto, objeto, asoc_id, identificador, padre_proyecto, padre_objeto, padre_id, padre_clave, hijo_proyecto, hijo_objeto, hijo_id, hijo_clave, cascada, orden) VALUES (
	...
	'262000052', --padre_objeto
	'persona', --padre_id
	NULL, --padre_clave
	'leanInicial', --hijo_proyecto
	'262000053', --hijo_objeto
...
INSERT INTO apex_objeto_rel_columnas_asoc (proyecto, objeto, asoc_id, padre_objeto, padre_clave, hijo_objeto, hijo_clave) VALUES (
	...
	'262000001', --asoc_id
	'262000052', --padre_objeto
	'262000034', --padre_clave
	'262000053', --hijo_objeto
	'262000047'  --hijo_clave
);
